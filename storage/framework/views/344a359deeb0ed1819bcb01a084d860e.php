...
<?php endif; ?>
    ...
    <div>
   <a class="underline text-sm text-gray-600 dark:text-red-400 hover:text-blue-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH /home/mohamed/Documents/projects/ChatApp/resources/views/auth/login.blade.php ENDPATH**/ ?>